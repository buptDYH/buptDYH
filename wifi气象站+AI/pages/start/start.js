...
Page({
  ...
  data: {
    ...
    rule: 'up',
    items: [
      { name: 'up', value: '是否高于设定值' ,checked:'ture'},
      { name: 'down', value: '是否低于设定值' },
    ]
  },
  ...
  send: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=%E5%8C%97%E4%BA%AC&output=json&ak=Y5GjLFHGGAsZuCOAZ8ve3pZk1bQagnCt', //百度天气API
      header: {
